package com.freqwency.promotr.view.search
...
class SearchResultCategoryAdapter(private val activity: Context,
                                  private val actions: ArrayList<PromocodeByCategoryResponse.PromoCodes>?) :
    RecyclerView.Adapter<SearchResultCategoryAdapter.ViewHolder>() {
